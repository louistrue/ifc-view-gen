...
export default function ZoomWindowOverlay({
    ...
    const handleMouseUp = (e: React.MouseEvent) => {
        ...
        if (rectWidth > 20 && rectHeight > 20 && navigationManager && overlayRef.current) {
            // Use the canvas container dimensions to match camera projection
            const canvasWidth = containerRef.current?.clientWidth || overlayRef.current.clientWidth
            const canvasHeight = containerRef.current?.clientHeight || overlayRef.current.clientHeight
